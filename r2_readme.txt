...
demo1,2,3,4.py contain syntax which help me understand the idea of "R-Squared" AKA "R2".
...
If R2 is at or near 1.0, that means that the data is predictable and the model is accurate.
...
I demonstrate R2 using Python scripts demo1,2,3,4.py
